...
class EmbeddingUtils:
    @staticmethod
    def check_is_request(model: TextEmbedder, embedding: Embedding) -> bool:
    ...
    def _get_default_request_and_proposal_embeddings(model: TextEmbedder) -> Tuple[Embedding, Embedding]:
